...
const androidKeys = {
  consumerKey: 'mXeF9xPD3Zy9JP1HmxnZ',
  consumerSecret: 'ruxLYlh6yz',
  appName: 'votethereum',
};
...
const LoginScreen: React.FC = () => {
  ...
  const handleKakaoLogin = async () => {
    try {
      ...
      // 백엔드 서버에 사용자 정보 전송
      const response = await fetch('http://10.0.2.2:8080/innovel/users/login', {
        method: 'POST',
        headers: {
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity
        ...
        style={styles.button}>
        <Image
          source={require('../../assets/naverbutton.png')}
          style={styles.buttonImage}
        />
      </TouchableOpacity>

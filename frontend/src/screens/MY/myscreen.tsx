...
const profileImage = require('../../assets/My/Profile.png');
const faceImage = require('../../assets/My/Face.png');
const arrowIcon = require('../../assets/My/Arrow.png');
...
const MyScreen: React.FC = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.separator}/>
      <Text style={styles.headerText}>나의 선거</Text>
      <TouchableOpacity onPress={() => navigation.navigate('MyNovel')}>
        <Text style={styles.menuText}>투표 결과 조회</Text>
      </TouchableOpacity>

...
public class VoteRateDto {
    ...
    // 생성자
    public VoteRateDto(Long candidateId, String name, int supportCount, double voteRate) {
    ...
    public double getVoteRate() { return voteRate; }
    public void setVoteRate(double voteRate) { this.voteRate = voteRate; }
}
